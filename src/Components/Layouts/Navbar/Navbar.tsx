...
function Navbar() {
  ...
  return <nav className={Styles.navbar}>
    ...
    <div className={Styles.rightContainer}>
      <Link to="/login" className={Styles.userContainer}><AccountCircleIcon/></Link>
      <Link to="/shoppingcartpage" className={Styles.shoppingContainer}><LocalMallOutlinedIcon/>Shopping bag</Link>
    </div>
