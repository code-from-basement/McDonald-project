    ...
    <div className={Styles.aboutOurFood}>
      ...
      <div className={Styles.detailsContainer}>
        ...
        <div className={Styles.detailsContainer_content}>
          <p>We’ve been a part of Australian communities for more than 50 years, serving great quality, great value food and creating feel-good Macca’s moments for our people, customers and communities.</p>
          <p>
            We know we have a responsibility and opportunity to drive positive outcomes from the farm to the front counter and beyond, in the areas that matter most to our customers, employees, suppliers, franchisees and
            communities.
          </p>
          <p>Changing for the better? We’re On It.</p>
        </div>
      </div>
          ...
          <div className={Styles.cardContainerOdd}>
            <motion.div className={Styles.card} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <div className={Styles.card_content}>
                ...
                <p>McDonald’s has been purchasing fresh produce, ingredients, and products from Aussie farmers and suppliers for more than 50 years, serving up a homegrown menu, wherever possible.</p>
          ...
          <div className={Styles.cardContainerEven}>
            <motion.div className={Styles.card} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <div className={Styles.card_content}>
                <h3>Our planet</h3>
                <p>
                  We are doing our part to protect the planet for communities today and into the future: from minimising how much plastic we use in our packaging, to driving climate action and partnering to advance
          ...
          <div className={Styles.cardContainerOdd}>
            <motion.div className={Styles.card} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <div className={Styles.card_content}>
                ...
                <p>We are committed to playing an active role in local communities through providing jobs, supporting local charities and sporting clubs, and contributing in times of need.</p>
                <div className={Styles.card_content_link}>
                  <a href="#">Explore more</a>
                </div>
              </div>
          ...
          <div className={Styles.cardContainerEven}>
            <motion.div className={Styles.card} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <div className={Styles.card_content}>
                ...
                <p>As one of the largest employers in Australia, we are serving up bright futures for our people by offering a supportive and inclusive working environment and world-class training programs.</p>
                <div className={Styles.card_content_link}>
                  <a href="#">Explore more</a>
                </div>
              </div>
